...
cprequire_test(["inline:us-munier-chilipeppr-widget-first"], function(myWidget) {
...
cpdefine("inline:us-munier-chilipeppr-widget-first", ["chilipeppr_ready", /* other dependencies here */ ], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "us-munier-chilipeppr-widget-first", // Make the id the same as the cpdefine id
        name: "My first Widget / Template", // The descriptive name of your widget.
        desc: "This my first widget not sure what it will do.", // A description of what your widget does
